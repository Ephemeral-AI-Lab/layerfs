...
- Dedicated report: `../../f-series/f0.md`. Compact machine manifest:
...
- The v3 terminal campaign/report below remain unchanged as the prior accepted
  ...
  `v3-follow-up.md`, with new release evidence at
...
- The complete final evidence is
  `v3-terminal-benchmark.md`; the only accepting
  campaign is
...
- F0: may begin only as a separate next work item; the repaired five-lane
  re-audit is PASS in `independent-audit.md`.
...
> `independent-audit.md`. The original checkpoint below
...
Frozen evidence report: `0-baseline-freeze.md`.
...
Detailed report: `1-authority-witness.md`.
...
Detailed report: `2-shadow-proof.md`.
...
Detailed report: `3-commit-reconciliation.md`.
...
Detailed report: `4-accounting.md`.
...
`5-release-comparison.md` and the hashed structural summary.
