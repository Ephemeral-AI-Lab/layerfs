...
Read: AGENTS.md; PHASE_4_ROLLING_BACK_TO_PREVIOUS_OPTIMIZATION_{SPEC,IMPLEMENTATION_PLAN}.md (WP4-M/P,WP8/9); ../mapping/logical-persistence.md; ../storage/sqlite/visible-head.md; ../algorithm/complexity-analysis.md; ../algorithm/spec.md; ../algorithm/tests-and-benchmarks.md; ../rollback/deletion-record.md; referenced Phase-1/2/3 doc; crates/layerfs-{core,engine} production/tests. Confirm branch/status and no Cargo writer.
