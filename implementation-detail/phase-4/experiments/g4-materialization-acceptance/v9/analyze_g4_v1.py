...
SOURCE = Path("/Users/yifanxu/Ephemeral-AI-Lab/layerfs-empty/implementation-detail/phase-4/experiments/g4-materialization-acceptance/v8/analyze_g4_v1.py")
EXPECTED = "cb67568c6d95b3da5ac98623cbd54fa9220527bc5cf7d4c02bc2e294f8e6ab25"
if hashlib.sha256(SOURCE.read_bytes()).hexdigest() != EXPECTED:
    raise SystemExit("frozen v8 primary analyzer custody mismatch")
try:
...
ignored = {"protected-adjacent-degradation-8", "protected-adjacent-degradation-29", "protected-adjacent-degradation-30"}
issues = [value for value in report["issues"] if value not in ignored]
if micro["range_ns"] > 3_000_000:
    issues.append("protected-range-absolute-target")
if micro["edit_ns"] > 10_000_000:
    issues.append("protected-edit-absolute-target")
if micro["reopen_ns"] > 5_000_000:
    issues.append("protected-reopen-absolute-target")
...
report.update({"schema": "phase4-g4-primary-analysis-v9", "status": "PASS" if not issues else "REVISE", "issues": sorted(set(issues)), "normalized_ledger": ledger, "normalized_ledger_sha256": digest})
