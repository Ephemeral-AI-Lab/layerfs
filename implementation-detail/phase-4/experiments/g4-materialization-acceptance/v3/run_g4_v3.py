...
runner.HERE = HERE
runner.MANIFEST = HERE / "METHODOLOGY-MANIFEST-v3.tsv"
runner.TARGET = REPO / "target/phase4-g4-materialization-acceptance-20260822-v3"
runner.RESULTS = runner.TARGET / "results-v3"
runner.WORK = runner.TARGET / "work-v3"
