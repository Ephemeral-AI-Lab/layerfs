...
runner.HERE = HERE
runner.MANIFEST = HERE / "METHODOLOGY-MANIFEST-v5.tsv"
runner.TARGET = REPO / "target/phase4-g4-materialization-acceptance-20260822-v5"
runner.RESULTS = runner.TARGET / "results-v5"
runner.WORK = runner.TARGET / "work-v5"
...
if __name__ == "__main__":
    ...
    if wall.is_file():
        ...
        if overruns:
            raise SystemExit(f"sealed v5 bucket overrun: {overruns}")
