...
EXECUTION_PRIMARY = HERE / "analyzers/primary_attempt_4.py"
EXECUTION_INDEPENDENT = HERE / "analyzers/independent_attempt_4.py"
...
ATTEMPT_4_BINDING = HERE / "ATTEMPT-4-METHOD-BINDING-v3.json"
...
RESULT_NAMES = {"screen": "phase4-g5-warm-projection-v3-screen-attempt-4", "gate": "phase4-g5-warm-projection-v3-gate-attempt-4"}
AUTHORITATIVE = (
...
def verify_attempt_4_binding():
    binding = load_json(ATTEMPT_4_BINDING)
    expected = {
        "runner_attempt_4_sha256": sha256(pathlib.Path(__file__)),
        "frozen_runner_sha256": sha256(HERE / "runner.py"),
        "runner_attempt_3_sha256": sha256(HERE / "runner_attempt_3.py"),
        "attempt_3_binding_sha256": sha256(HERE / "ATTEMPT-3-METHOD-BINDING-v3.json"),
        "attempt_3_disposition_sha256": sha256(HERE / "SCREEN-ATTEMPT-3-v3.json"),
        ...
        "primary_attempt_4_sha256": sha256(EXECUTION_PRIMARY),
        "independent_attempt_4_sha256": sha256(EXECUTION_INDEPENDENT),
    }
    if binding.get("status") != "PROSPECTIVE_BEFORE_ATTEMPT_4" or binding.get("scope") != "AnalyzerContentionOverlapFieldNameOnly" or binding.get("hashes") != expected or binding.get("screen_limit_ns") != LIMITS["screen"] or binding.get("gate_limit_ns") != LIMITS["gate"] or binding.get("mode_populations") != MODE_POPULATIONS or binding.get("threshold_or_population_change") is not False:
        raise RuntimeError("attempt-4 method binding mismatch")
    return binding
...
def self_check():
    ...
    result = {"schema": "phase4-g5-2-runner-self-check-v3-attempt-4", "status": "PASS", "checks": len(cases) + 11, "product_processes": 0, "product_rows": 0, "partial_process_evidence_retained": True, "directory_rebind_exact": True, "private_permission_map_exact": True, "contention_overlap_field_exact": True}
