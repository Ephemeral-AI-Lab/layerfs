# G5-2 v2 preregistration

Status: `PREMEASUREMENT_REVISE`.

V2 prospectively supersedes terminal v1. It changes the product evidence schema
...
evaluation. No v1 product row, screen, gate, or measurement is reused.

The current disposition is `PREMEASUREMENT_REVISE`: preparation, freeze,
screen, and gate remain closed until the observed fault matrix, authoritative
engine/schema extraction, and clean G5-1 rerun in `PROMOTION-READINESS-v2.md`
are complete.
