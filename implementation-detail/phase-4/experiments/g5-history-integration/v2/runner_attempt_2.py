...
PRIMARY=HERE/"analyzers/primary_attempt_2.py"; INDEPENDENT=HERE/"analyzers/independent_attempt_2.py"; READINESS=HERE/"PREMEASUREMENT-READINESS-ATTEMPT-2-v2.json"; INPUT_MANIFEST=HERE/"method/INPUT-MANIFEST-v2.json"; PREPARATION_TERMINAL=HERE/"method/PREPARATION-TERMINAL-v2.json"; FREEZE=HERE/"method/SOURCE-FREEZE-ATTEMPT-2-v2.json"; FORECAST=HERE/"ZERO-ROW-FORECAST-ATTEMPT-2-v2.json"
FOCUSED=HERE/"FOCUSED-TEST-ATTEMPTS-v2.json"; DISPOSITION=HERE/"SCREEN-ATTEMPT-1-DISPOSITION-v2.json"; FOCUSED_ATTEMPT=HERE/"evidence/focused-attempt-1"; ATTEMPT_BINDING=HERE/"ATTEMPT-2-METHOD-BINDING-v2.json"; BASE_FREEZE=HERE/"method/SOURCE-FREEZE-v2.json"; BASE_FORECAST=HERE/"ZERO-ROW-FORECAST-v2.json"
STATIC_CLOSURE=HERE/"POST-SCREEN-STATIC-CLOSURE-ATTEMPT-2-v2.json"; STATIC_EVIDENCE=HERE/"evidence/post-screen-static-closure-attempt-2"
LOCK=TARGET/"phase4-g5-history-integration"/"BENCHMARK_LOCK"; RESULTS={"screen":"phase4-g5-history-integration-v2-screen-attempt-2","gate":"phase4-g5-history-integration-v2-gate-attempt-2"}
