...
def recompute(raw_file, timing_file, schedule_file, expected_file):
    ...
    rows = [value for value in documents if value.get("schema") == "phase4-g5-1-operation-v2"]
    ends = [value for value in documents if value.get("schema") == "phase4-g5-trusted-child-terminal-v2"]
    ...
    for value in rows:
        ...
        for field in (
            ...
            "edit_base_complete_scrub_calls",
    ...
    return {
        "schema": "phase4-g5-1-independent-recomputation-v2",
