...
OP_SCHEMA = "phase4-g5-1-operation-v2"
TERMINAL_SCHEMA = "phase4-g5-trusted-child-terminal-v2"
...
def analyze(raw_path, timing_path, schedule_path, expected_path):
    ...
    return {"schema": "phase4-g5-1-primary-analysis-v2", "status": "PASS" if not failures else "REVISE", "normalized": normalized}
