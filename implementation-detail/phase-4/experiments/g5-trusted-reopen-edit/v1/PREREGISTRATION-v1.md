# Phase 4 G5-1 v1 preregistration
...
Any failure preserves v1. No row is deleted, replaced, reordered, or selectively
rerun. A source or method repair creates v2.
...
healthy root/transition/logical DB/work      = exact parity
