# G5-1 v12 sample-count interpretation addendum

This note is controlling for any abbreviated statement of v12 sample intent.
...
V12 voluntarily preserves the deliberately stricter v1-lineage design:
...
preserves v12 as `PREMEASUREMENT_REVISE` without row reduction. A narrower
sample interpretation requires a new prospective v12 method.
