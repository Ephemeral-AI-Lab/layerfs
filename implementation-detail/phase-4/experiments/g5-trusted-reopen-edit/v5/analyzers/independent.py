...
def recompute(raw_file, timing_file, schedule_file, expected_file):
    ...
    rows = [value for value in documents if value.get("schema") == "phase4-g5-1-operation-v5"]
    ends = [value for value in documents if value.get("schema") == "phase4-g5-trusted-child-terminal-v5"]
    semantic = [value for value in documents if value.get("schema") == "phase4-g5-trusted-semantic-v5"]
    semantic_ends = [value for value in documents if value.get("schema") == "phase4-g5-trusted-semantic-terminal-v5"]
    sentinel = [value for value in documents if value.get("schema") == "phase4-g5-1-protected-sentinel-v5"]
    ...
    return {
        "schema": "phase4-g5-1-independent-recomputation-v5",
