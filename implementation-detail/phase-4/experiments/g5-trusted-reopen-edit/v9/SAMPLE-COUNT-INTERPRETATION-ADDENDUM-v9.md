# G5-1 v9 sample-count interpretation addendum

This note is controlling for any abbreviated statement of v9 sample intent.
...
V9 voluntarily preserves the deliberately stricter v1-lineage design:
...
preserves v9 as `PREMEASUREMENT_REVISE` without row reduction. A narrower
sample interpretation requires a new prospective v10 method.
