# Phase 4 G5-1 v7 preregistration
...
Any failure preserves v7. No row is deleted, replaced, reordered, or selectively
rerun. A source or method repair creates v8.
...
failure preserves v7 without reducing rows.
