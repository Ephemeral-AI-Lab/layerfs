...
def recompute(raw_file, timing_file, schedule_file, expected_file):
    ...
    rows = [value for value in documents if value.get("schema") == "phase4-g5-1-operation-v7"]
    ends = [value for value in documents if value.get("schema") == "phase4-g5-trusted-child-terminal-v7"]
    semantic = [value for value in documents if value.get("schema") == "phase4-g5-trusted-semantic-v7"]
    semantic_ends = [value for value in documents if value.get("schema") == "phase4-g5-trusted-semantic-terminal-v7"]
    sentinel = [value for value in documents if value.get("schema") == "phase4-g5-1-protected-sentinel-v7"]
    ...
    return {
        "schema": "phase4-g5-1-independent-recomputation-v7",
