...
V24 = HISTORY / "v24"
METHOD = HERE / "method"
SCHEDULE = METHOD / "SCHEDULE-v27.tsv"
EXPECTED = METHOD / "EXPECTED-OUTCOMES-v27.tsv"
INPUT_MANIFEST = METHOD / "INPUT-MANIFEST-v27.tsv"
METHOD_MANIFEST = METHOD / "METHOD-MANIFEST-v27.tsv"
SOURCE_FREEZE = METHOD / "SOURCE-FREEZE-v27.json"
FREEZE_VERIFICATION = HERE / "FREEZE-VERIFICATION-v27.json"
LIMITATIONS = HERE / "LIMITATIONS-v27.json"
STATIC_CLOSURE = HERE / "STATIC-CLOSURE-ATTEMPT-2-EXECUTION-v27.json"
DRY_RUN = HERE / "DRY-RUN-v27.json"
DRY_RUN_INTENT = HERE / "DRY-RUN-INTENT-v27.json"
DRY_RUN_CALIBRATION_STDOUT = HERE / "DRY-RUN-CALIBRATION-v27.stdout"
DRY_RUN_CALIBRATION_STDERR = HERE / "DRY-RUN-CALIBRATION-v27.stderr"
DRY_RUN_CALIBRATION_TERMINAL = HERE / "DRY-RUN-CALIBRATION-TERMINAL-v27.json"
DRY_RUN_DISPOSITION = HERE / "DRY-RUN-DISPOSITION-v27.json"
DRY_RUN_FAILED = HERE / "DRY-RUN-FAILED-v27.json"
PREMEASUREMENT_REVISE = HERE / "PREMEASUREMENT-REVISE-v27.json"
WRAPPER_CALIBRATION_INTENT = HERE / "WRAPPER-CALIBRATION-INTENT-v27.json"
WRAPPER_CALIBRATION_RAW = HERE / "WRAPPER-CALIBRATION-RAW-v27.jsonl"
WRAPPER_CALIBRATION_RESULT = HERE / "WRAPPER-CALIBRATION-RESULT-v27.json"
PRIMARY = HERE / "analyzers/primary_attempt_2.py"
INDEPENDENT = HERE / "analyzers/independent_attempt_2.py"
ATTEMPT_2_BINDING = HERE / "ATTEMPT-2-METHOD-BINDING-v27.json"
...
SCREEN_RESULT = REPO / f"target/phase4-g5-trusted-reopen-edit-{DATE}-v27-screen-attempt-2"
GATE_RESULT = REPO / f"target/phase4-g5-trusted-reopen-edit-{DATE}-v27-attempt-2"
WRAPPER_CALIBRATION_ROOT = (
    REPO / f"target/phase4-g5-trusted-reopen-edit-wrapper-calibration-{DATE}-v27"
)

# V27 is a prospective matched-control repair. Product hashes remain unset until
# focused parity/readiness settles both release binaries.
G5_CHILD_BINARY = HERE / "g5-benchmark/target/release/layerfs-g5-trusted-child-v27"
G5_CHILD_BINARY_SHA256 = (
    hashlib.sha256(G5_CHILD_BINARY.read_bytes()).hexdigest()
    if G5_CHILD_BINARY.is_file() else None
)
...
SENTINEL_SCHEMA = "phase4-g5-1-protected-sentinel-v27"
REQUEST_FIELDS = (
...
FROZEN_G4_EXECUTABLE = (
    REPO
    / "target/phase4-g4-materialization-acceptance-20260822-v12/results-v12"
    / "operands-v1/phase4_create_edit_benchmark-g4"
)
FROZEN_G4_EXECUTABLE_SHA256 = "e72988fc25e96f608d0d405e157ea8e837029595ace916f066932082a736db33"
G4_EXECUTABLE = HERE / "g4-control/target/release/layerfs-g4-control-v27"
G4_EXECUTABLE_SHA256 = (
    hashlib.sha256(G4_EXECUTABLE.read_bytes()).hexdigest()
    if G4_EXECUTABLE.is_file() else None
)
G4_FROZEN_SOURCE_SHA256 = "01886da1d413ce73bbeba38f1b5cbc45a939e9d50e69fa7273c1af33f65554cb"
G4_FINAL_MANIFEST = FROZEN_G4_EXECUTABLE.parents[1] / "FINAL-ARTIFACT-HASHES-v1.tsv"
G4_FINAL_MANIFEST_SHA256 = "585be251a1bd1a260a12415790a0e8f4cd59271217c8533639971a11a4c0b012"
G4_ARM_RAW = FROZEN_G4_EXECUTABLE.parents[1] / "ARM-RAW-v1.jsonl"
...
V24_RELEASE_SHA256 = "aaecd980122fa7f1ca6792fffb227c6ea526983dc7c604ccdac540a090041810"
...
V23_SUPERSESSION = V24 / "V23-SUPERSESSION-v24.json"
V23_SUPERSESSION_SHA256 = "35a58dc3f2e63144976915df2f183defcaad2d4113a73abcddc4095a32f32bf9"
V24_ANTI_CHEAT = V24 / "G5-1-ANTI-CHEAT-DISPOSITION-v24.json"
V24_ANTI_CHEAT_SHA256 = "1a0d5d7072f611dcd1d3d33928d25db629baa2eb5406c58f016790e11cd1cdc6"
V24_SUPERSESSION = HISTORY / "v26/V24-SUPERSESSION-v26.json"
V24_SUPERSESSION_SHA256 = "6c118e16123670d65b170884e14dca73b37058c09fe903fc3907bba5abb00caf"
V26_MEASURED_REVISE = HISTORY / "v26/MEASURED-REVISE-v26.json"
V26_MEASURED_REVISE_SHA256 = "819d360eac32c652ba4687ca84de6b955dba278f7a235842b9e8aa659cd45a43"
V26_SUPERSESSION = HERE / "V26-SUPERSESSION-v27.json"
V26_SUPERSESSION_SHA256 = "daa66a08c0e193ece32ad1fcb89ad1ee6119b6942d8983727f1b8b97417afa9e"
PATCHED_G4_PARITY = HERE / "G4-PATCHED-CONTROL-PARITY-v27.json"
CACHE1280_EVIDENCE_ROOT = HERE / "evidence/cache1280-final"
G5_RETAINED_SOURCE = next(
    (HERE / "g5-benchmark/target/release/build").glob(
        "layerfs-g5-trusted-child-v27-*/out/retained_control.rs"
    )
)
G4_RETAINED_SOURCE = next(
    (HERE / "g4-control/target/release/build").glob(
        "layerfs-g4-control-v27-*/out/retained_control.rs"
    )
)
...
LIMIT_NS = {"screen": 20_000_000_000, "gate": 150_000_000_000}
RSS_LIMIT = 20_971_520
PRODUCT_PROCESS_ENVIRONMENT = {"MallocNanoZone": "0"}
PRECONDITION_DIAGNOSTIC = (
    REPO / "target/phase4-g5-trusted-reopen-edit-20260823-v24-precondition-ab/PRECONDITION-AB-v24.json"
)
PRECONDITION_DIAGNOSTIC_SHA256 = "b54d31392bfab79cc972cdcb1c1d17a0dfc066cce570160e3d43aaaf6350edf1"
PRECONDITION_BUFFER_BYTES = 64 * 1024
PRECONDITION_CONSERVATIVE_FACTOR = 4
GATE_G5_ARMS = 150
...
FORECAST_MODEL_VERSION = "phase4-g5-1-v27-fast-law-forecast-v5"
...
PHYSICAL_ALLOCATION_SCHEMA = "g5-v27-physical-allocation-observation-v1"
...
CHILD_LIFECYCLE_SCHEMA = "phase4-g5-1-product-child-lifecycle-v27"
RSS_CLASSIFICATION = "PerProductChildRetainedPeak"
SYNCHRONOUS_RSS_KIND = "synchronous-one-shot"
ARM_CLEANUP_SCHEMA = "phase4-g5-1-arm-cleanup-receipt-v27"
WORK_ROOT_LIFECYCLE_SCHEMA = "phase4-g5-1-work-root-lifecycle-v27"
...
def tracked_diff_hash():
    return sha256_bytes(status_bytes())
...
def status_bytes():
    return (
        compact(
            {
                "classification": "GlobalWorktreeNotMethodAuthority",
                "authority": "ExplicitSourceManifest",
                "branch": BRANCH,
...
def verify_repository_identity():
    ...
    verify_file(G5_CHILD_BINARY, V24_RELEASE_SHA256)
    verify_file(V23_SUPERSESSION, V23_SUPERSESSION_SHA256)
    verify_file(V24_ANTI_CHEAT, V24_ANTI_CHEAT_SHA256)
    verify_file(V24_SUPERSESSION, V24_SUPERSESSION_SHA256)
...
def verify_repository_identity():
    ...
    for relative, expected in CONTROLLING_HASHES.items():
        verify_file(REPO / relative, expected)
    for path, expected in (
        (G4_EXECUTABLE, G4_EXECUTABLE_SHA256),
        (FROZEN_G4_EXECUTABLE, FROZEN_G4_EXECUTABLE_SHA256),
        (G4_FINAL_MANIFEST, G4_FINAL_MANIFEST_SHA256),
        (G4_ARM_RAW, G4_ARM_RAW_SHA256),
        (V10_INPUT_MANIFEST, V10_INPUT_MANIFEST_SHA256),
        (G5_CHILD_BINARY, G5_CHILD_BINARY_SHA256),
        (V24_ANTI_CHEAT, V24_ANTI_CHEAT_SHA256),
        (V26_MEASURED_REVISE, V26_MEASURED_REVISE_SHA256),
        (V26_SUPERSESSION, V26_SUPERSESSION_SHA256),
        (PRECONDITION_DIAGNOSTIC, PRECONDITION_DIAGNOSTIC_SHA256),
    ):
        verify_file(path, expected)
    supersession = json.loads(V26_SUPERSESSION.read_text(encoding="utf-8"))
    if (
        supersession.get("status") != "PASS"
        or supersession.get("product_release_reuse") is not False
        or supersession.get("sealed_input_reuse") is not True
        or supersession.get("v26_rows_reused") is not False
        or supersession.get("v27_authority_requires_fresh_rows") is not True
    ):
        raise RuntimeError("v26-to-v27 supersession control mismatch")


def expected_schedule_execution(row):
    return (
        "pair-scoped-native-semantic"
        if row["category"] == "fault"
        else "one-shot"
        if row["category"] == "sentinel"
        else "one-shot-sequence-scoped-balanced"
    )
...
def schedule_rows(campaign=None):
    ...
    for row in rows:
        expected_execution = expected_schedule_execution(row)
        if row["execution"] != expected_execution:
            raise RuntimeError(
                f"schedule process-shape mismatch: {row['sequence_id']} {row['execution']}"
            )
...
def method_source_names():
    fixed = {
        ...
        for path in (
            HERE / "PREREGISTRATION-v27.md",
            HERE / "REVIEW-SYNTHESIS-v27.md",
            HERE / "SAMPLE-COUNT-INTERPRETATION-ADDENDUM-v27.md",
            HERE / "FOCUSED-TEST-ATTEMPTS-v27.json",
            HERE / "PREMEASUREMENT-READINESS-AUDIT-v27.json",
            LIMITATIONS,
            HERE / "runner.py",
            PRIMARY,
            INDEPENDENT,
            ...
            G5_RETAINED_SOURCE,
            HERE / "g4-control/Cargo.toml",
            HERE / "g4-control/Cargo.lock",
            HERE / "g4-control/build.rs",
            HERE / "g4-control/src/main.rs",
            HERE / "g4-control/src/session.rs",
            G4_RETAINED_SOURCE,
        )
    }
    ...
    fixed.update(
        str(path.relative_to(REPO))
        for path in CACHE1280_EVIDENCE_ROOT.rglob("*")
        if path.is_file()
    )
    return sorted(fixed)
...
def freeze_interface_contract():
    return {
        "product_operand_version": "v27",
        "product_release_reuse": False,
        "product_release_sha256": G5_CHILD_BINARY_SHA256,
        "g4_control_operand_version": "v27-patched-from-frozen-g4-source",
        "g4_control_release_sha256": G4_EXECUTABLE_SHA256,
        "frozen_g4_baseline_release_sha256": FROZEN_G4_EXECUTABLE_SHA256,
        "frozen_g4_source_sha256": G4_FROZEN_SOURCE_SHA256,
        "matched_sqlite_cache_size_pages": 1280,
        "baseline_sqlite_cache_size_pages": 2000,
        "new_sqlite_release_calls": 0,
        "preexisting_g5_post_request_cleanup": "Unchanged",
        ...
        "wrapper_calibration": {
            ...
            "intent_schema": "phase4-g5-1-wrapper-calibration-intent-v27",
            "initialization_schema": "phase4-g5-1-wrapper-initialization-sample-v27",
            "sample_schema": "phase4-g5-1-wrapper-calibration-sample-v27",
            "result_schema": "phase4-g5-1-wrapper-calibration-result-v27",
...
def write_input_and_method_manifests():
    ...
    assert all(row["execution"] == expected_schedule_execution(row) for row in schedule_rows())
    mutated_execution = dict(schedule_rows()[0], execution="sequence-scoped-persistent-balanced")
    assert mutated_execution["execution"] != expected_schedule_execution(mutated_execution)
    assert not action_authorized({"status": "PASS", "authorization": {}}, "--prepare-inputs")
    assert action_authorized(
        {"status": "PASS", "authorization": {"input_adoption_and_freeze": True}},
        "--prepare-inputs",
    )
    ...
    freeze = {
        "schema": "phase4-g5-1-source-freeze-v27",
        ...
        "post_freeze_verification": {
            ...
            "schema": "phase4-g5-1-freeze-verification-v27",
...
def current_freeze_bindings(freeze):
    ...
    required_authority_relatives = {
        str(V26_MEASURED_REVISE.relative_to(REPO)),
        str(V26_SUPERSESSION.relative_to(REPO)),
        str(V24_ANTI_CHEAT.relative_to(REPO)),
        str(PATCHED_G4_PARITY.relative_to(REPO)),
    }
    if verification_relative in explicit_sources or not required_authority_relatives.issubset(
        explicit_sources
    ):
        raise RuntimeError("freeze verification cycle or current-authority omission")
    ...
    return {
        ...
        "v26_measured_revise_sha256": sha256(V26_MEASURED_REVISE),
        "v26_supersession_sha256": sha256(V26_SUPERSESSION),
        "patched_g4_parity_sha256": sha256(PATCHED_G4_PARITY),
        "v24_anti_cheat_sha256": sha256(V24_ANTI_CHEAT),
...
def run_preparation_command(
    ...
    chronology = evidence_root / "CHRONOLOGY-v27.jsonl"
    ...
    write_json(
        intent,
        {
            "schema": "phase4-g5-1-preparation-command-intent-v27",
            "ordinal": ordinal,
            "label": label,
            "argv": command,
    ...
    terminal = {
        "schema": "phase4-g5-1-preparation-command-terminal-v27",
        "ordinal": ordinal,
        "label": label,
...
def prepare_inputs():
    ...
    if any(
        ...
        raise RuntimeError("v27 method/freeze evidence already exists")
    if not os.access(G5_CHILD_BINARY, os.X_OK):
        raise RuntimeError(f"hash-bound v27 child is not executable: {G5_CHILD_BINARY}")
    ...
    if future_input not in sources or missing:
        raise RuntimeError(f"v27 method source preflight mismatch: {missing}")
    write_input_and_method_manifests()
    if verify_sealed_input_manifest() != 93:
        raise RuntimeError("v27 reused input manifest cardinality mismatch")
...
def verify_dry_run(freeze):
    ...
    required = {
        "schema": "phase4-g5-1-dry-run-v27",
        "status": "PASS",
        "measured_rows": 0,
        "benchmark_child_processes_started": 0,
        "stores_opened": 0,
    ...
    intent_required = {
        "schema": "phase4-g5-1-dry-run-intent-v27",
        "status": "STARTED",
        "branch": BRANCH,
        "head": CHECKPOINT,
    ...
    if (
        ...
        or disposition.get("schema") != "phase4-g5-1-dry-run-disposition-v27"
...
def verify_freeze(require_static=False, require_dry=False):
    ...
    if require_static:
        ...
        screen_terminal = SCREEN_RESULT / "TERMINAL-VERIFICATION-v27.json"
        screen_final_manifest = SCREEN_RESULT / "FINAL-ARTIFACT-HASHES-v27.tsv"
        screen_final_verification = SCREEN_RESULT / "FINAL-READONLY-VERIFICATION-v27.json"
        screen_complete_wall = SCREEN_RESULT / "COMPLETE-WALL-v27.json"
        required = {
            "schema": "phase4-g5-1-static-closure-v27",
            "status": "PASS",
            "source_freeze_sha256": sha256(SOURCE_FREEZE),
            "tracked_diff_sha256": freeze["tracked_diff_sha256"],
...
def gate_workload_enumeration():
    ...
    return {
        ...
        "persistent_transport_line_file_fsync_calls": 0,
        "persistent_transport_line_directory_fsync_calls": 0,
        ...
        "one_shot_evidence_file_fsync_calls": (g4_arms + g5_requests) * 3,
        "one_shot_evidence_directory_fsync_calls": (g4_arms + g5_requests) * 3,
        "runner_fsync_call_enumeration": {
            ...
            "persistent_transport_file_calls": 0,
            "persistent_transport_directory_calls": 0,
            "one_shot_evidence_file_calls": (g4_arms + g5_requests) * 3,
            "one_shot_evidence_directory_calls": (g4_arms + g5_requests) * 3,
...
def hash_calibration():
    ...
    write_json(
        DRY_RUN_CALIBRATION_TERMINAL,
        {
            "schema": "phase4-g5-1-dry-run-calibration-terminal-v27",
            "status": "RETURNED",
            "return_code": completed.returncode,
    ...
    return {
        "schema": "phase4-g5-1-hash-calibration-v27",
...
def wrapper_calibration_plan():
    ...
    plan = {
        "schema": "phase4-g5-1-wrapper-calibration-plan-v27",
...
def run_wrapper_calibration(freeze, plan):
    ...
    intent = {
        "schema": "phase4-g5-1-wrapper-calibration-intent-v27",
        "status": "STARTED",
    ...
    try:
        ...
        initialization_evidence = {
            "schema": "phase4-g5-1-wrapper-initialization-evidence-v27",
        ...
        initialization = {
            "schema": "phase4-g5-1-wrapper-initialization-sample-v27",
            "status": "PASS",
        ...
        for sample_index in range(1, WRAPPER_CALIBRATION_SAMPLES + 1):
            ...
            representative = {
                "schema": "phase4-g5-1-wrapper-calibration-representative-arm-v27",
                "sample": sample_index,
                "master": master["relative_path"],
            ...
            sample = {
                "schema": "phase4-g5-1-wrapper-calibration-sample-v27",
                "status": "PASS",
                "sample": sample_index,
                "master": master["relative_path"],
                "phases_ns": phases,
        ...
        try:
            ...
            if WRAPPER_CALIBRATION_ROOT.exists():
                if (
                    ...
                    != f"phase4-g5-trusted-reopen-edit-wrapper-calibration-{DATE}-v27"
                ):
    ...
    result = {
        "schema": "phase4-g5-1-wrapper-calibration-result-v27",
        "status": "PASS",
        "classification": "ZeroProductWrapperCalibration",
...
def verify_wrapper_calibration(freeze):
    ...
    if (
        ...
        != "phase4-g5-1-wrapper-initialization-sample-v27"
    ...
    for sample_index, sample in enumerate(samples, start=1):
        ...
        if (
            sample.get("schema") != "phase4-g5-1-wrapper-calibration-sample-v27"
...
def dry_failure_documents(error_type, error_message, intent_sha256, collected, artifacts):
    failed = {
        "schema": "phase4-g5-1-dry-run-failed-v27",
        "status": "REVISE",
    ...
    disposition = {
        "schema": "phase4-g5-1-dry-run-disposition-v27",
        "status": "REVISE",
        "classification": "UNEXPECTED_DRY_RUN_FAILURE",
        "intent_sha256": intent_sha256,
...
def dry_run():
    ...
    if any(path.exists() for path in evidence_paths):
        raise RuntimeError("v27 dry-run evidence already exists")
    if not FREEZE_VERIFICATION.is_file():
        raise RuntimeError("v27 dry-run requires durable freeze verification")
    ...
    try:
        ...
        value = {
            ...
            "sample_count_interpretation": "deliberately-stricter-v27-choice-not-unambiguous-user-minimum",
        ...
        if status == "REVISE":
            write_json(
                PREMEASUREMENT_REVISE,
                {
                    "schema": "phase4-g5-1-premeasurement-revise-v27",
                    "status": "REVISE",
...
def release_lock(lock, result, terminal_verification=None, state="release"):
    ...
    try:
        ...
        attestation = result / "BENCHMARK-LOCK-RELEASE-ATTESTATION-v27.json"
        ...
        value = {
            "schema": "phase4-g5-1-lock-release-v27",
        ...
        write_json(result / "LOCK-RELEASE-v27.json", value)
        return value
    finally:
        os.close(lock["fd"])
        lock["fd"] = None
...
def precondition_database(root):
    databases = sorted(pathlib.Path(root).glob("*.sqlite"))
    if len(databases) != 1:
        raise RuntimeError("expected one candidate database for preconditioning")
    database = databases[0]
    expected = database.stat().st_size
    buffer = bytearray(PRECONDITION_BUFFER_BYTES)
    ...
    if observed != expected:
        raise RuntimeError("candidate database precondition byte count mismatch")
    return {
        "classification": "MirrorsFrozenG4InternalPreTimerDatabaseHashRead",
        "timing_claim": "CacheWarmPreconditionedNotColdReopen",
        "database": database.name,
        "bytes": observed,
        "buffer_bytes": PRECONDITION_BUFFER_BYTES,
        "wall_ns": wall_ns,
        "inside_complete_wall": True,
        "inside_product_timer": False,
        "layerfs_sql_or_authentication_work": False,
    }


def attempt_2_forecast(dry):
    verify_file(PRECONDITION_DIAGNOSTIC, PRECONDITION_DIAGNOSTIC_SHA256)
    diagnostic = json.loads(PRECONDITION_DIAGNOSTIC.read_text(encoding="utf-8"))
    observed = diagnostic["preconditioned"]["precondition"]["wall_ns"]
    per_arm_bound = observed * PRECONDITION_CONSERVATIVE_FACTOR
    component = per_arm_bound * GATE_G5_ARMS
    forecast = dry["full_wrapper_forecast_ns"] + component
    if forecast > LIMIT_NS["gate"]:
        raise RuntimeError("attempt-2 preconditioned forecast exceeds gate wall")
    return forecast, {
        "diagnostic_sha256": PRECONDITION_DIAGNOSTIC_SHA256,
        "observed_precondition_wall_ns": observed,
        "conservative_factor": PRECONDITION_CONSERVATIVE_FACTOR,
        "per_g5_arm_bound_ns": per_arm_bound,
        "g5_gate_arms": GATE_G5_ARMS,
        "gate_component_ns": component,
        "base_forecast_ns": dry["full_wrapper_forecast_ns"],
        "attempt_2_forecast_ns": forecast,
        "gate_limit_ns": LIMIT_NS["gate"],
    }


def run_semantic(executable, case, root, result, label, lifecycle=None):
    stdout = result / f"children-v27/{label}.stdout"
    stderr = result / f"children-v27/{label}.stderr"
    sidecar = result / f"time-v27/{label}.txt"
...
def validate_child_row(envelope):
    ...
    return {
        "schema": "phase4-g5-1-operation-v27",
...
class PersistentChild:
    def __init__(
        ...
        self.stdout_path = result / f"children-v27/{self.label}.stdout"
        self.stderr_path = result / f"children-v27/{self.label}.stderr"
        self.time_path = result / f"time-v27/{self.label}.txt"
        ...
        try:
            ...
            environment.update(PRODUCT_PROCESS_ENVIRONMENT)
    ...
    def close(self):
        ...
        if (
            terminal.get("schema") != CHILD_TERMINAL_SCHEMA
            or terminal.get("status") != "PASS"
            or terminal.get("expected_rows") != self.expected_rows
            or terminal.get("rows") != self.expected_rows
        ):
...
def run_oneshot(
    ...
    if not g4:
        if custody is None or forecast_ns is None or executable_sha256 is None:
            raise RuntimeError("G5 one-shot transport requires frozen custody and forecast")
        child = None
        if lifecycle is not None:
            lifecycle.synchronous_start(label)
        try:
            ...
            row = child.request(request)
            terminal = child.close()
            if terminal is None or terminal.get("q_current") != 0 or any(
                terminal.get(field) != 0
                for field in (
                    "argument_owners", "request_owners", "schedule_owners",
                    "timing_owners", "report_owners",
                )
            ):
                raise RuntimeError(f"G5 one-shot terminal mismatch: {label}")
            row["external_time"] = terminal["external_time"]
            row["command"] = child.command
            row["command_environment"] = dict(PRODUCT_PROCESS_ENVIRONMENT)
            if lifecycle is not None:
                lifecycle.synchronous_finish(label, terminal["external_time"])
                lifecycle.terminals.append(terminal)
            return row
        except BaseException:
            if child is not None:
                child.abort()
            if lifecycle is not None and label in lifecycle._synchronous_children:
                lifecycle.synchronous_finish(label)
            raise
    stdout = result / f"children-v27/{label}.stdout"
    stderr = result / f"children-v27/{label}.stderr"
    sidecar = result / f"time-v27/{label}.txt"
    command = g4_command(executable, request)
    environment_values = {}
    environment = None
    if g4:
        if custody is None:
        ...
        environment_values = dict(PRODUCT_PROCESS_ENVIRONMENT)
        environment = os.environ.copy()
        environment.update(environment_values)
    if lifecycle is not None:
        lifecycle.synchronous_start(label)
...
def analyze(result):
    ...
    for analyzer, name in (
        (PRIMARY, "PRIMARY-ANALYSIS-v27.json"),
        (INDEPENDENT, "INDEPENDENT-RECOMPUTATION-v27.json"),
    ):
        output = result / name
        completed = subprocess.run(
            [
                sys.executable, str(analyzer), str(result / "RAW-v27.jsonl"),
                str(result / "TIMINGS-v27.tsv"), str(SCHEDULE), str(EXPECTED), str(output),
            ],
            cwd=REPO,
            text=True,
            capture_output=True,
    ...
    write_json(
        result / "ANALYZER-AGREEMENT-v27.json",
        {
            "schema": "phase4-g5-1-analyzer-agreement-v27",
...
def run_prearm_wrapper_initialization(result, freeze, dry, lock):
    ...
    evidence = {
        "schema": "phase4-g5-1-prearm-wrapper-initialization-evidence-v27",
    ...
    evidence_path = result / "PREARM-WRAPPER-INITIALIZATION-EVIDENCE-v27.json"
    write_json(evidence_path, evidence)
    total_ns = max(1, time.monotonic_ns() - started)
    value = {
        **evidence,
        "schema": "phase4-g5-1-prearm-wrapper-initialization-v27",
    ...
    write_json(result / "PREARM-WRAPPER-INITIALIZATION-v27.json", value)
    if value["status"] != "PASS":
...
def ladder_prelock(campaign):
    ...
    if campaign == "gate":
        paths.extend(
            (
                SCREEN_RESULT / "TERMINAL-VERIFICATION-v27.json",
                SCREEN_RESULT / "FINAL-ARTIFACT-HASHES-v27.tsv",
                SCREEN_RESULT / "FINAL-READONLY-VERIFICATION-v27.json",
                SCREEN_RESULT / "COMPLETE-WALL-v27.json",
                STATIC_CLOSURE,
            )
        )
...
def run_campaign(campaign):
    ...
    try:
        ...
        forecast_ns, precondition_forecast = attempt_2_forecast(dry)
        result.mkdir(mode=0o700)
        work = result.parent / f"{result.name}-work-v27"
        work.mkdir(mode=0o700)
        work_roots = ArmWorkRootLifecycle(work)
        for name in ("operands-v27", "children-v27", "time-v27"):
            (result / name).mkdir()
        fsync_dir(result)
        fsync_dir(result.parent)

        g4_copy = result / "operands-v27/frozen-g4-verified"
        g5_copy = result / "operands-v27/g5-verified-trusted"
        ...
        write_json(
            result / "OPERAND-CUSTODY-v27.json",
            {
                "schema": "phase4-g5-1-operand-custody-v27",
        ...
        write_json(
            result / "PREFLIGHT-v27.json",
            {
                "schema": "phase4-g5-1-preflight-v27",
                "status": "PASS",
                "campaign": campaign,
                "branch": BRANCH,
                "checkpoint": CHECKPOINT,
        ...
        write_json(
            result / "DATABASE-PRECONDITION-FORECAST-v27.json",
            {
                "schema": "phase4-g5-1-database-precondition-forecast-v27",
                "status": "PASS",
                "campaign": campaign,
                "timing_claim": "CacheWarmPreconditionedNotColdReopen",
                **precondition_forecast,
            },
        )
        write_json(
            result / "ENVIRONMENT-v27.json",
            {
                "schema": "phase4-g5-1-environment-v27",
        ...
        shutil.copyfile(INPUT_MANIFEST, result / "INPUT-CUSTODY-v27.tsv")
        with (result / "INPUT-CUSTODY-v27.tsv").open("rb") as handle:
            os.fsync(handle.fileno())
        ...
        try:
            for sequence in consecutive_observation_groups(observations, ("sequence_id",)):
                ...
                sequence_children = {}
                required_g5_children = [
                    f"{observation['ordinal']:03d}-{sequence_id}-{observation['role']}"
                        ...
                        try:
                            for observation in pair_rows:
                                ...
                                if observation["role"] == "g4_verified":
                                    database_precondition = {
                                        "classification": (
                                            "NotAppliedFrozenG4HashesDatabaseInternallyBeforeProductTimer"
                                        ),
                                        "timing_claim": "CacheWarmPreconditionedNotColdReopen",
                                        "bytes": 0,
                                        "buffer_bytes": 0,
                                    ...
                                    database_precondition = precondition_database(row_root)
                                    value = run_oneshot(
                                        g5_copy,
                                        request,
                                        result,
                                        ...
                                        executable_sha256=freeze["g5_executable_sha256"],
                                    )
                                ...
                                value.update(
                                    wrapper={
                                        ...
                                        "product_process_shape": "one-shot",
                                        ...
                                        "database_precondition": database_precondition,
                    ...
                    semantics.extend(
                        {
                            ...
                            "expectation_id": "native-semantic-v27",
                            "status": value["status"],
                            "error": value["error"],
                        }
                        for value in values
        ...
        write_json(result / "PRODUCT-CHILD-LIFECYCLE-v27.json", child_lifecycle)
        write_json(result / "WORK-ROOT-LIFECYCLE-v27.json", work_root_lifecycle)

        write_text(result / "RAW-v27.jsonl", "".join(compact(row) + "\n" for row in raw))
        timing_fields = (
        ...
        write_text(
            result / "TIMINGS-v27.tsv",
            "\t".join(timing_fields) + "\n"
            + "".join("\t".join(str(row[name]) for name in timing_fields) + "\n" for row in timings),
        )
        write_text(
            result / "SEMANTIC-FAULT-RESULTS-v27.tsv",
        ...
        write_json(result / "COMMANDS-v27.json", {"schema": "phase4-g5-1-commands-v27", "commands": commands})
        analyze(result)

        if work.parent != result.parent or not work.name.endswith("-work-v27"):
            raise RuntimeError("refusing unsafe work cleanup")
        shutil.rmtree(work)
        fsync_dir(work.parent)
        residue = [str(path) for path in result.parent.glob(f"{result.name}-work-v27")]
        write_json(
            result / "CLEANUP-v27.json",
            {
                "schema": "phase4-g5-1-cleanup-v27",
        ...
        payload_excluded = {
            "PAYLOAD-MANIFEST-v27.tsv", "MEASURED-TERMINAL-v27.json",
            "TERMINAL-VERIFICATION-v27.json", "COMPLETE-WALL-v27.json",
            "BENCHMARK-LOCK-RELEASE-ATTESTATION-v27.json", "LOCK-RELEASE-v27.json",
            "FINAL-ARTIFACT-HASHES-v27.tsv", "FINAL-READONLY-VERIFICATION-v27.json",
        }
        payload = result / "PAYLOAD-MANIFEST-v27.tsv"
        ...
        terminal = result / "MEASURED-TERMINAL-v27.json"
        write_json(
            terminal,
            {
                "schema": "phase4-g5-1-measured-terminal-v27",
                "status": "PASS",
                "campaign": campaign,
                "rows": len(timings),
                ...
                "product_child_lifecycle_sha256": sha256(
                    result / "PRODUCT-CHILD-LIFECYCLE-v27.json"
                ),
                "work_root_lifecycle_sha256": sha256(
                    result / "WORK-ROOT-LIFECYCLE-v27.json"
                ),
                "prearm_wrapper_initialization_sha256": sha256(
                    result / "PREARM-WRAPPER-INITIALIZATION-v27.json"
                ),
        ...
        verification = result / "TERMINAL-VERIFICATION-v27.json"
        write_json(
            verification,
            {
                "schema": "phase4-g5-1-terminal-verification-v27",
                "status": "PASS",
        ...
        final = result / "FINAL-ARTIFACT-HASHES-v27.tsv"
        write_text(
            final,
            manifest_text(
                result,
                excluded={final.name, "FINAL-READONLY-VERIFICATION-v27.json", "COMPLETE-WALL-v27.json"},
            ),
        )
        final_count = verify_manifest(result, final, "result_relative_path")
        write_json(
            result / "FINAL-READONLY-VERIFICATION-v27.json",
            {
                "schema": "phase4-g5-1-final-readonly-verification-v27",
                "status": "PASS",
        ...
        write_json(
            result / "COMPLETE-WALL-v27.json",
            {
                "schema": "phase4-g5-1-complete-wall-v27",
                "status": "PASS",
                "campaign": campaign,
                ...
                "terminal_self_exclusion": "COMPLETE-WALL-v27.json follows the verified final manifest",
            },
        )
        fsync_dir(result)
        ...
        if result.exists() and not (result / "FAILED-v27.json").exists():
            write_json(
                result / "FAILED-v27.json",
                {
                    "schema": "phase4-g5-1-failure-v27",
                    "status": "REVISE",
                    "error": str(error),
...
def run_self_checks():
    ...
    with tempfile.TemporaryDirectory(prefix="layerfs-g5-v27-self-check-") as temporary:
        work = pathlib.Path(temporary) / "work-v27"
        work.mkdir()
        ...
        precondition_root = pathlib.Path(temporary) / "precondition"
        precondition_root.mkdir()
        database = precondition_root / "candidate.sqlite"
        database.write_bytes(b"x" * (PRECONDITION_BUFFER_BYTES + 7))
        precondition = precondition_database(precondition_root)
        assert precondition["bytes"] == PRECONDITION_BUFFER_BYTES + 7
        assert precondition["buffer_bytes"] == PRECONDITION_BUFFER_BYTES
        assert precondition["inside_complete_wall"] is True
        assert precondition["inside_product_timer"] is False
        assert precondition["layerfs_sql_or_authentication_work"] is False

    original_input = INPUT_ROOT
    original_custody = VERIFIED_INPUT_CUSTODY
    original_manifest_sha256 = VERIFIED_INPUT_MANIFEST_SHA256
    try:
        with tempfile.TemporaryDirectory(prefix="layerfs-g5-v27-forecast-check-") as temporary:
            ...
            assert workload["g5_one_shot_product_children"] == 150
            assert workload["g5_persistent_product_children"] == 0
            assert workload["g5_persistent_row_requests"] == 0
    ...
    assert FORECAST_MODEL_VERSION == "phase4-g5-1-v27-fast-law-forecast-v5"
    assert LIMIT_NS["gate"] == 150_000_000_000
    attempt_2_ns, attempt_2 = attempt_2_forecast(
        {"full_wrapper_forecast_ns": 106_971_161_667}
    )
    assert attempt_2_ns == 122_462_736_867
    assert attempt_2["gate_component_ns"] == 15_491_575_200
    assert attempt_2["g5_gate_arms"] == 150
    ...
    sources = method_source_names()
    assert str(HERE.joinpath("runner.py").relative_to(REPO)) in sources
    assert str(V24_ANTI_CHEAT.relative_to(REPO)) in sources
    assert str(V26_MEASURED_REVISE.relative_to(REPO)) in sources
    assert str(V26_SUPERSESSION.relative_to(REPO)) in sources
    assert str(PATCHED_G4_PARITY.relative_to(REPO)) in sources
    assert str(FROZEN_G4_EXECUTABLE.relative_to(REPO)) in sources
    assert str(G4_EXECUTABLE.relative_to(REPO)) in sources
    assert str(V10_INPUT_MANIFEST.relative_to(REPO)) in sources
    assert all(
        str(path.relative_to(REPO)) not in sources
        for path in (V9_SUPERSESSION, V10_SUPERSESSION, V11_SUPERSESSION,
                     V12_SUPERSESSION, V13_SUPERSESSION, V14_SUPERSESSION)
    )
    ...
    print(compact({"status": "PASS", "checks": 19, "gate_arms": 200, "checkpoints": 56}))
    return 0


def action_authorized(readiness, action):
    field = {
        "--prepare-inputs": "input_adoption_and_freeze",
        "--dry-run": "dry_run",
        "--screen": "screen",
        "--gate": "gate",
    }[action]
    return readiness.get("status") == "PASS" and readiness.get("authorization", {}).get(field) is True


def require_action_authorized(action):
    path = HERE / "PREMEASUREMENT-READINESS-AUDIT-v27.json"
    try:
        readiness = json.loads(path.read_text(encoding="utf-8"))
    except (OSError, json.JSONDecodeError) as error:
        raise RuntimeError("v27 readiness authority is absent or invalid") from error
    if not action_authorized(readiness, action):
        raise RuntimeError(f"v27 action is not authorized: {action}")
    parity = json.loads(PATCHED_G4_PARITY.read_text(encoding="utf-8"))
    products = readiness.get("product_custody", {})
    if (
        G4_EXECUTABLE_SHA256 is None
        or G5_CHILD_BINARY_SHA256 is None
        or products.get("patched_g4_executable_sha256") != G4_EXECUTABLE_SHA256
        or products.get("g5_child_executable_sha256") != G5_CHILD_BINARY_SHA256
        or parity.get("status") != "PASS"
        or parity.get("patched_g4_executable_sha256") != G4_EXECUTABLE_SHA256
        or parity.get("frozen_g4_baseline_executable_sha256")
        != FROZEN_G4_EXECUTABLE_SHA256
        or parity.get("sole_difference")
        != "MatchedSQLiteCacheSizePages2000To1280"
    ):
        raise RuntimeError("v27 product custody or patched-G4 parity is not authorized")


def verify_attempt_2_binding():
    binding = json.loads(ATTEMPT_2_BINDING.read_text(encoding="utf-8"))
    expected = {
        "runner_attempt_2_sha256": sha256(pathlib.Path(__file__)),
        "primary_attempt_2_sha256": sha256(PRIMARY),
        "independent_attempt_2_sha256": sha256(INDEPENDENT),
        "source_freeze_sha256": sha256(SOURCE_FREEZE),
        "dry_run_sha256": sha256(DRY_RUN),
        "schedule_sha256": sha256(SCHEDULE),
        "expectations_sha256": sha256(EXPECTED),
        "g4_executable_sha256": G4_EXECUTABLE_SHA256,
        "g5_executable_sha256": G5_CHILD_BINARY_SHA256,
    }
    if (
        binding.get("status") != "PASS"
        or binding.get("scope") != "AnalyzerPatchedG4HashOnly"
        or any(binding.get(key) != value for key, value in expected.items())
        or binding.get("threshold_change") is not False
        or binding.get("population_change") is not False
        or binding.get("screen_result_root") != str(SCREEN_RESULT.relative_to(REPO))
        or binding.get("gate_result_root") != str(GATE_RESULT.relative_to(REPO))
        or binding.get("static_closure") != str(STATIC_CLOSURE.relative_to(REPO))
    ):
        raise RuntimeError("v27 attempt-2 method binding mismatch")
    return binding
...
def main():
    ...
    verify_attempt_2_binding()
    if sys.argv[1] == "--self-check":
        return run_self_checks()
    require_action_authorized(sys.argv[1])
