...
REPO = HERE.parents[4]
METHOD = HERE / "method"
SCHEDULE = METHOD / "SCHEDULE-v14.tsv"
EXPECTED = METHOD / "EXPECTED-OUTCOMES-v14.tsv"
INPUT_MANIFEST = METHOD / "INPUT-MANIFEST-v14.tsv"
METHOD_MANIFEST = METHOD / "METHOD-MANIFEST-v14.tsv"
SOURCE_FREEZE = METHOD / "SOURCE-FREEZE-v14.json"
FREEZE_VERIFICATION = HERE / "FREEZE-VERIFICATION-v14.json"
LIMITATIONS = HERE / "LIMITATIONS-v14.json"
STATIC_CLOSURE = HERE / "STATIC-CLOSURE-v14.json"
DRY_RUN = HERE / "DRY-RUN-v14.json"
DRY_RUN_INTENT = HERE / "DRY-RUN-INTENT-v14.json"
DRY_RUN_CALIBRATION_STDOUT = HERE / "DRY-RUN-CALIBRATION-v14.stdout"
DRY_RUN_CALIBRATION_STDERR = HERE / "DRY-RUN-CALIBRATION-v14.stderr"
DRY_RUN_CALIBRATION_TERMINAL = HERE / "DRY-RUN-CALIBRATION-TERMINAL-v14.json"
DRY_RUN_DISPOSITION = HERE / "DRY-RUN-DISPOSITION-v14.json"
DRY_RUN_FAILED = HERE / "DRY-RUN-FAILED-v14.json"
PREMEASUREMENT_REVISE = HERE / "PREMEASUREMENT-REVISE-v14.json"
WRAPPER_CALIBRATION_INTENT = HERE / "WRAPPER-CALIBRATION-INTENT-v14.json"
WRAPPER_CALIBRATION_RAW = HERE / "WRAPPER-CALIBRATION-RAW-v14.jsonl"
WRAPPER_CALIBRATION_RESULT = HERE / "WRAPPER-CALIBRATION-RESULT-v14.json"
...
SCREEN_RESULT = REPO / f"target/phase4-g5-trusted-reopen-edit-{DATE}-v14-screen"
GATE_RESULT = REPO / f"target/phase4-g5-trusted-reopen-edit-{DATE}-v14"
WRAPPER_CALIBRATION_ROOT = (
    REPO / f"target/phase4-g5-trusted-reopen-edit-wrapper-calibration-{DATE}-v14"
)

# V14 is a method-only revision and reuses the exact hash-verified v10 operands.
G5_CHILD_BINARY = HERE.parent / "v10/g5-benchmark/target/release/layerfs-g5-trusted-child-v10"
...
SENTINEL_SCHEMA = "phase4-g5-1-protected-sentinel-v14"
REQUEST_FIELDS = (
...
V13_SUPERSESSION = HERE / "V13-SUPERSESSION-v14.json"
...
FORECAST_MODEL_VERSION = "phase4-g5-1-v14-fast-law-forecast-v5"
...
PHYSICAL_ALLOCATION_SCHEMA = "g5-v14-physical-allocation-observation-v1"
...
CHILD_LIFECYCLE_SCHEMA = "phase4-g5-1-product-child-lifecycle-v14"
RSS_CLASSIFICATION = "PerProductChildRetainedPeak"
SYNCHRONOUS_RSS_KIND = "synchronous-one-shot"
ARM_CLEANUP_SCHEMA = "phase4-g5-1-arm-cleanup-receipt-v14"
WORK_ROOT_LIFECYCLE_SCHEMA = "phase4-g5-1-work-root-lifecycle-v14"
...
def verify_repository_identity():
    ...
    verify_file(G5_CHILD_BINARY, V10_RELEASE_SHA256)
    ...
    v10_method_rehash = independent_manifest_rehash(
        REPO, V10_METHOD_MANIFEST, "repo_relative_path"
    )
    v10_frozen_method = json.loads(
        V10_FREEZE_VERIFICATION.read_text(encoding="utf-8")
    ).get("bindings", {}).get("method_manifest")
    v10_method_rehash.pop("row_paths")
    if v10_method_rehash != v10_frozen_method or v10_method_rehash["row_count"] != 66:
        raise RuntimeError("v10 method manifest row custody mismatch")
    ...
    v11_method_rehash = independent_manifest_rehash(
        REPO, V11_METHOD_MANIFEST, "repo_relative_path"
    )
    v11_frozen_method = json.loads(
        V11_FREEZE_VERIFICATION.read_text(encoding="utf-8")
    ).get("bindings", {}).get("method_manifest")
    v11_method_rehash.pop("row_paths")
    if v11_method_rehash != v11_frozen_method or v11_method_rehash["row_count"] != 67:
        raise RuntimeError("v11 method manifest row custody mismatch")
    for path, expected in (
    ...
    v12_method_rehash = independent_manifest_rehash(
        REPO, V12_METHOD_MANIFEST, "repo_relative_path"
    )
    v12_frozen_method = json.loads(
        V12_FREEZE_VERIFICATION.read_text(encoding="utf-8")
    ).get("bindings", {}).get("method_manifest")
    v12_method_rehash.pop("row_paths")
    if v12_method_rehash != v12_frozen_method or v12_method_rehash["row_count"] != 72:
        raise RuntimeError("v12 method manifest row custody mismatch")
    for path, expected in (
    ...
    v13_method_rehash = independent_manifest_rehash(
        REPO, V13_METHOD_MANIFEST, "repo_relative_path"
    )
    v13_frozen_method = json.loads(
        V13_FREEZE_VERIFICATION.read_text(encoding="utf-8")
    ).get("bindings", {}).get("method_manifest")
    v13_method_rehash.pop("row_paths")
    if v13_method_rehash != v13_frozen_method or v13_method_rehash["row_count"] != 78:
        raise RuntimeError("v13 method manifest row custody mismatch")
...
def method_source_names():
    fixed = {
        ...
        for path in (
            HERE / "PREREGISTRATION-v14.md",
            HERE / "REVIEW-SYNTHESIS-v14.md",
            HERE / "SAMPLE-COUNT-INTERPRETATION-ADDENDUM-v14.md",
            HERE / "FOCUSED-TEST-ATTEMPTS-v14.json",
            HERE / "PREMEASUREMENT-READINESS-AUDIT-v14.json",
            LIMITATIONS,
            HERE / "runner.py",
            PRIMARY,
            INDEPENDENT,
...
def freeze_interface_contract():
    return {
        "product_operand_version": "v10",
        "product_release_reuse": True,
        "product_release_sha256": V10_RELEASE_SHA256,
        ...
        "wrapper_calibration": {
            ...
            "intent_schema": "phase4-g5-1-wrapper-calibration-intent-v14",
            "initialization_schema": "phase4-g5-1-wrapper-initialization-sample-v14",
            "sample_schema": "phase4-g5-1-wrapper-calibration-sample-v14",
            "result_schema": "phase4-g5-1-wrapper-calibration-result-v14",
...
def write_input_and_method_manifests():
    ...
    freeze = {
        "schema": "phase4-g5-1-source-freeze-v14",
        ...
        "post_freeze_verification": {
            ...
            "schema": "phase4-g5-1-freeze-verification-v14",
...
def run_preparation_command(
    ...
    chronology = evidence_root / "CHRONOLOGY-v14.jsonl"
    ...
    write_json(
        intent,
        {
            "schema": "phase4-g5-1-preparation-command-intent-v14",
            "ordinal": ordinal,
            "label": label,
            "argv": command,
    ...
    terminal = {
        "schema": "phase4-g5-1-preparation-command-terminal-v14",
        "ordinal": ordinal,
        "label": label,
...
def prepare_inputs():
    ...
    if any(
        ...
        raise RuntimeError("v14 method/freeze evidence already exists")
    if not os.access(G5_CHILD_BINARY, os.X_OK):
        raise RuntimeError(f"hash-bound v10 child is not executable: {G5_CHILD_BINARY}")
    ...
    if future_input not in sources or missing:
        raise RuntimeError(f"v14 method source preflight mismatch: {missing}")
    write_input_and_method_manifests()
    if verify_sealed_input_manifest() != 93:
        raise RuntimeError("v14 reused input manifest cardinality mismatch")
...
def verify_dry_run(freeze):
    ...
    required = {
        "schema": "phase4-g5-1-dry-run-v14",
        "status": "PASS",
        "measured_rows": 0,
        "benchmark_child_processes_started": 0,
        "stores_opened": 0,
    ...
    intent_required = {
        "schema": "phase4-g5-1-dry-run-intent-v14",
        "status": "STARTED",
        "branch": BRANCH,
        "head": CHECKPOINT,
    ...
    if (
        ...
        or disposition.get("schema") != "phase4-g5-1-dry-run-disposition-v14"
...
def verify_freeze(require_static=False, require_dry=False):
    ...
    if require_static:
        ...
        screen_terminal = SCREEN_RESULT / "TERMINAL-VERIFICATION-v14.json"
        screen_final_manifest = SCREEN_RESULT / "FINAL-ARTIFACT-HASHES-v14.tsv"
        screen_final_verification = SCREEN_RESULT / "FINAL-READONLY-VERIFICATION-v14.json"
        screen_complete_wall = SCREEN_RESULT / "COMPLETE-WALL-v14.json"
        required = {
            "schema": "phase4-g5-1-static-closure-v14",
            "status": "PASS",
            "source_freeze_sha256": sha256(SOURCE_FREEZE),
            "tracked_diff_sha256": freeze["tracked_diff_sha256"],
...
def gate_workload_enumeration():
    ...
    return {
        "schema": "phase4-g5-1-prospective-workload-v14",
...
def hash_calibration():
    ...
    write_json(
        DRY_RUN_CALIBRATION_TERMINAL,
        {
            "schema": "phase4-g5-1-dry-run-calibration-terminal-v14",
            "status": "RETURNED",
            "return_code": completed.returncode,
    ...
    return {
        "schema": "phase4-g5-1-hash-calibration-v14",
...
def wrapper_calibration_plan():
    ...
    plan = {
        "schema": "phase4-g5-1-wrapper-calibration-plan-v14",
...
def run_wrapper_calibration(freeze, plan):
    ...
    intent = {
        "schema": "phase4-g5-1-wrapper-calibration-intent-v14",
        "status": "STARTED",
    ...
    try:
        ...
        initialization_evidence = {
            "schema": "phase4-g5-1-wrapper-initialization-evidence-v14",
        ...
        initialization = {
            "schema": "phase4-g5-1-wrapper-initialization-sample-v14",
            "status": "PASS",
        ...
        for sample_index in range(1, WRAPPER_CALIBRATION_SAMPLES + 1):
            ...
            representative = {
                "schema": "phase4-g5-1-wrapper-calibration-representative-arm-v14",
                "sample": sample_index,
                "master": master["relative_path"],
            ...
            sample = {
                "schema": "phase4-g5-1-wrapper-calibration-sample-v14",
                "status": "PASS",
                "sample": sample_index,
                "master": master["relative_path"],
                "phases_ns": phases,
        ...
        try:
            ...
            if WRAPPER_CALIBRATION_ROOT.exists():
                if (
                    ...
                    or not WRAPPER_CALIBRATION_ROOT.name.endswith(f"-{DATE}-v14")
                ):
    ...
    result = {
        "schema": "phase4-g5-1-wrapper-calibration-result-v14",
        "status": "PASS",
        "classification": "ZeroProductWrapperCalibration",
...
def verify_wrapper_calibration(freeze):
    ...
    if (
        ...
        != "phase4-g5-1-wrapper-initialization-sample-v14"
    ...
    for sample_index, sample in enumerate(samples, start=1):
        ...
        if (
            sample.get("schema") != "phase4-g5-1-wrapper-calibration-sample-v14"
...
def dry_failure_documents(error_type, error_message, intent_sha256, collected, artifacts):
    failed = {
        "schema": "phase4-g5-1-dry-run-failed-v14",
        "status": "REVISE",
    ...
    disposition = {
        "schema": "phase4-g5-1-dry-run-disposition-v14",
        "status": "REVISE",
        "classification": "UNEXPECTED_DRY_RUN_FAILURE",
        "intent_sha256": intent_sha256,
...
def dry_run():
    ...
    if any(path.exists() for path in evidence_paths):
        raise RuntimeError("v14 dry-run evidence already exists")
    if not FREEZE_VERIFICATION.is_file():
        raise RuntimeError("v14 dry-run requires durable freeze verification")
    ...
    try:
        ...
        value = {
            ...
            "sample_count_interpretation": "deliberately-stricter-v14-choice-not-unambiguous-user-minimum",
        ...
        if status == "REVISE":
            write_json(
                PREMEASUREMENT_REVISE,
                {
                    "schema": "phase4-g5-1-premeasurement-revise-v14",
                    "status": "REVISE",
...
def release_lock(lock, result, terminal_verification=None, state="release"):
    ...
    try:
        ...
        attestation = result / "BENCHMARK-LOCK-RELEASE-ATTESTATION-v14.json"
        ...
        value = {
            "schema": "phase4-g5-1-lock-release-v14",
        ...
        write_json(result / "LOCK-RELEASE-v14.json", value)
        return value
    finally:
        os.close(lock["fd"])
        lock["fd"] = None
...
def run_semantic(executable, case, root, result, label, lifecycle=None):
    stdout = result / f"children-v14/{label}.stdout"
    stderr = result / f"children-v14/{label}.stderr"
    sidecar = result / f"time-v14/{label}.txt"
...
def validate_child_row(envelope):
    ...
    return {
        "schema": "phase4-g5-1-operation-v14",
...
class PersistentChild:
    def __init__(
        ...
        self.stdout_path = result / f"children-v14/{self.label}.stdout"
        self.stderr_path = result / f"children-v14/{self.label}.stderr"
        self.time_path = result / f"time-v14/{self.label}.txt"
...
def analyze(result):
    ...
    for analyzer, name in (
        (PRIMARY, "PRIMARY-ANALYSIS-v14.json"),
        (INDEPENDENT, "INDEPENDENT-RECOMPUTATION-v14.json"),
    ):
        output = result / name
        completed = subprocess.run(
            [
                sys.executable, str(analyzer), str(result / "RAW-v14.jsonl"),
                str(result / "TIMINGS-v14.tsv"), str(SCHEDULE), str(EXPECTED), str(output),
            ],
            cwd=REPO,
            text=True,
            capture_output=True,
    ...
    write_json(
        result / "ANALYZER-AGREEMENT-v14.json",
        {
            "schema": "phase4-g5-1-analyzer-agreement-v14",
...
def run_prearm_wrapper_initialization(result, freeze, dry, lock):
    ...
    evidence = {
        "schema": "phase4-g5-1-prearm-wrapper-initialization-evidence-v14",
    ...
    evidence_path = result / "PREARM-WRAPPER-INITIALIZATION-EVIDENCE-v14.json"
    write_json(evidence_path, evidence)
    total_ns = max(1, time.monotonic_ns() - started)
    value = {
        **evidence,
        "schema": "phase4-g5-1-prearm-wrapper-initialization-v14",
    ...
    write_json(result / "PREARM-WRAPPER-INITIALIZATION-v14.json", value)
    if value["status"] != "PASS":
...
def ladder_prelock(campaign):
    ...
    if campaign == "gate":
        paths.extend(
            (
                SCREEN_RESULT / "TERMINAL-VERIFICATION-v14.json",
                SCREEN_RESULT / "FINAL-ARTIFACT-HASHES-v14.tsv",
                SCREEN_RESULT / "FINAL-READONLY-VERIFICATION-v14.json",
                SCREEN_RESULT / "COMPLETE-WALL-v14.json",
                STATIC_CLOSURE,
            )
        )
...
def run_campaign(campaign):
    ...
    try:
        ...
        work = result.parent / f"{result.name}-work-v14"
        work.mkdir(mode=0o700)
        work_roots = ArmWorkRootLifecycle(work)
        for name in ("operands-v14", "children-v14", "time-v14"):
            (result / name).mkdir()
        fsync_dir(result)
        fsync_dir(result.parent)

        g4_copy = result / "operands-v14/frozen-g4-verified"
        g5_copy = result / "operands-v14/g5-verified-trusted"
        ...
        write_json(
            result / "OPERAND-CUSTODY-v14.json",
            {
                "schema": "phase4-g5-1-operand-custody-v14",
        ...
        write_json(
            result / "PREFLIGHT-v14.json",
            {
                "schema": "phase4-g5-1-preflight-v14",
                "status": "PASS",
                "campaign": campaign,
                "branch": BRANCH,
                "checkpoint": CHECKPOINT,
        ...
        write_json(
            result / "ENVIRONMENT-v14.json",
            {
                "schema": "phase4-g5-1-environment-v14",
        ...
        shutil.copyfile(INPUT_MANIFEST, result / "INPUT-CUSTODY-v14.tsv")
        with (result / "INPUT-CUSTODY-v14.tsv").open("rb") as handle:
            os.fsync(handle.fileno())
                    ...
                    semantics.extend(
                        {
                            ...
                            "expectation_id": "native-semantic-v14",
                            "status": value["status"],
                            "error": value["error"],
                        }
                        for value in values
        ...
        write_json(result / "PRODUCT-CHILD-LIFECYCLE-v14.json", child_lifecycle)
        write_json(result / "WORK-ROOT-LIFECYCLE-v14.json", work_root_lifecycle)

        write_text(result / "RAW-v14.jsonl", "".join(compact(row) + "\n" for row in raw))
        timing_fields = (
        ...
        write_text(
            result / "TIMINGS-v14.tsv",
            "\t".join(timing_fields) + "\n"
            + "".join("\t".join(str(row[name]) for name in timing_fields) + "\n" for row in timings),
        )
        write_text(
            result / "SEMANTIC-FAULT-RESULTS-v14.tsv",
        ...
        write_json(result / "COMMANDS-v14.json", {"schema": "phase4-g5-1-commands-v14", "commands": commands})
        analyze(result)

        if work.parent != result.parent or not work.name.endswith("-work-v14"):
            raise RuntimeError("refusing unsafe work cleanup")
        shutil.rmtree(work)
        fsync_dir(work.parent)
        residue = [str(path) for path in result.parent.glob(f"{result.name}-work-v14")]
        write_json(
            result / "CLEANUP-v14.json",
            {
                "schema": "phase4-g5-1-cleanup-v14",
        ...
        payload_excluded = {
            "PAYLOAD-MANIFEST-v14.tsv", "MEASURED-TERMINAL-v14.json",
            "TERMINAL-VERIFICATION-v14.json", "COMPLETE-WALL-v14.json",
            "BENCHMARK-LOCK-RELEASE-ATTESTATION-v14.json", "LOCK-RELEASE-v14.json",
            "FINAL-ARTIFACT-HASHES-v14.tsv", "FINAL-READONLY-VERIFICATION-v14.json",
        }
        payload = result / "PAYLOAD-MANIFEST-v14.tsv"
        ...
        terminal = result / "MEASURED-TERMINAL-v14.json"
        write_json(
            terminal,
            {
                "schema": "phase4-g5-1-measured-terminal-v14",
                "status": "PASS",
                "campaign": campaign,
                "rows": len(timings),
                ...
                "product_child_lifecycle_sha256": sha256(
                    result / "PRODUCT-CHILD-LIFECYCLE-v14.json"
                ),
                "work_root_lifecycle_sha256": sha256(
                    result / "WORK-ROOT-LIFECYCLE-v14.json"
                ),
                "prearm_wrapper_initialization_sha256": sha256(
                    result / "PREARM-WRAPPER-INITIALIZATION-v14.json"
                ),
        ...
        verification = result / "TERMINAL-VERIFICATION-v14.json"
        write_json(
            verification,
            {
                "schema": "phase4-g5-1-terminal-verification-v14",
                "status": "PASS",
        ...
        final = result / "FINAL-ARTIFACT-HASHES-v14.tsv"
        write_text(
            final,
            manifest_text(
                result,
                excluded={final.name, "FINAL-READONLY-VERIFICATION-v14.json", "COMPLETE-WALL-v14.json"},
            ),
        )
        final_count = verify_manifest(result, final, "result_relative_path")
        write_json(
            result / "FINAL-READONLY-VERIFICATION-v14.json",
            {
                "schema": "phase4-g5-1-final-readonly-verification-v14",
                "status": "PASS",
        ...
        write_json(
            result / "COMPLETE-WALL-v14.json",
            {
                "schema": "phase4-g5-1-complete-wall-v14",
                "status": "PASS",
                "campaign": campaign,
                ...
                "terminal_self_exclusion": "COMPLETE-WALL-v14.json follows the verified final manifest",
            },
        )
        fsync_dir(result)
        ...
        if result.exists() and not (result / "FAILED-v14.json").exists():
            write_json(
                result / "FAILED-v14.json",
                {
                    "schema": "phase4-g5-1-failure-v14",
                    "status": "REVISE",
                    "error": str(error),
...
def run_self_checks():
    ...
    with tempfile.TemporaryDirectory(prefix="layerfs-g5-v14-self-check-") as temporary:
        work = pathlib.Path(temporary) / "work-v14"
        work.mkdir()
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="layerfs-g5-v14-forecast-check-") as temporary:
    ...
    assert FORECAST_MODEL_VERSION == "phase4-g5-1-v14-fast-law-forecast-v5"
