# G5-1 v14 sample-count interpretation addendum

This note is controlling for any abbreviated statement of v14 sample intent.
...
V14 voluntarily preserves the deliberately stricter v1-lineage design:
...
preserves v14 as `PREMEASUREMENT_REVISE` without row reduction. A narrower
sample interpretation requires a new prospective v15 method.
