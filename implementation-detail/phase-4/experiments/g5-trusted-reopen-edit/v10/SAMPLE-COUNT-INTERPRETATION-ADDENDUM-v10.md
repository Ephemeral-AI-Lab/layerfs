# G5-1 v10 sample-count interpretation addendum

This note is controlling for any abbreviated statement of v10 sample intent.
...
V10 voluntarily preserves the deliberately stricter v1-lineage design:
...
same 200-arm distributions and their root, transition, ordered logical catalog,
...
zero-row counters, and a complete-wrapper forecast `<=120 s`. Forecast failure
preserves v10 as `PREMEASUREMENT_REVISE` without row reduction. A narrower
sample interpretation requires a new prospective v11 method.
