# G5-1 v21 sample-count interpretation addendum

This note is controlling for any abbreviated statement of v21 sample intent.
...
V21 voluntarily preserves the deliberately stricter v1-lineage design:
...
preserves v21 as `PREMEASUREMENT_REVISE` without row reduction. A narrower
sample interpretation requires a new prospective v21 method.
