# G5-1 v13 sample-count interpretation addendum

This note is controlling for any abbreviated statement of v13 sample intent.
...
V13 voluntarily preserves the deliberately stricter v1-lineage design:
...
preserves v13 as `PREMEASUREMENT_REVISE` without row reduction. A narrower
sample interpretation requires a new prospective v13 method.
