# G5-1 v24 sample-count interpretation addendum

This note is controlling for any abbreviated statement of v24 sample intent.
...
V24 voluntarily preserves the deliberately stricter v1-lineage design:
...
preserves v24 as `PREMEASUREMENT_REVISE` without row reduction. A narrower
sample interpretation requires a new prospective v24 method.
