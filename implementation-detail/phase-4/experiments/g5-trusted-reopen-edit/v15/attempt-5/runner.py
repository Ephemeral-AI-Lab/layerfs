...
LIMITATIONS = HERE.parent / "LIMITATIONS-v15.json"
...
SCREEN_RESULT = REPO / f"target/phase4-g5-trusted-reopen-edit-{DATE}-v15-screen-attempt-5"
GATE_RESULT = REPO / f"target/phase4-g5-trusted-reopen-edit-{DATE}-v15-attempt-5"
WRAPPER_CALIBRATION_ROOT = (
    REPO / f"target/phase4-g5-trusted-reopen-edit-wrapper-calibration-{DATE}-v15-attempt-5"
)

# V15 changes the product timer equation and uses a fresh hash-bound release.
G5_CHILD_BINARY = HERE.parent / "g5-benchmark/target/release/layerfs-g5-trusted-child-v15"
...
V14_SUPERSESSION = HERE.parent / "V14-SUPERSESSION-v15.json"
...
def method_source_names():
    fixed = {
        ...
        for path in (
            HERE.parent / "PREREGISTRATION-v15.md",
            HERE.parent / "REVIEW-SYNTHESIS-v15.md",
            HERE.parent / "SAMPLE-COUNT-INTERPRETATION-ADDENDUM-v15.md",
            HERE.parent / "FOCUSED-TEST-ATTEMPTS-v15.json",
            HERE.parent / "PREMEASUREMENT-READINESS-AUDIT-v15.json",
            HERE.parent / "SCREEN-ATTEMPT-1-v15.json",
            HERE.parent / "ATTEMPT-2-v15.json",
            HERE.parent / "ATTEMPT-3-v15.json",
            HERE.parent / "ATTEMPT-4-v15.json",
            LIMITATIONS,
            HERE / "runner.py",
            PRIMARY,
            INDEPENDENT,
            ...
            V13_SUPERSESSION,
            V14_SUPERSESSION,
            HERE.parent / "g5-benchmark/Cargo.toml",
            HERE.parent / "g5-benchmark/Cargo.lock",
            HERE.parent / "g5-benchmark/build.rs",
            HERE.parent / "g5-benchmark/src/main.rs",
            HERE.parent / "g5-benchmark/src/session.rs",
        )
    }
        ...
        try:
            ...
            if WRAPPER_CALIBRATION_ROOT.exists():
                if (
                    ...
                    != f"phase4-g5-trusted-reopen-edit-wrapper-calibration-{DATE}-v15-attempt-5"
                ):
