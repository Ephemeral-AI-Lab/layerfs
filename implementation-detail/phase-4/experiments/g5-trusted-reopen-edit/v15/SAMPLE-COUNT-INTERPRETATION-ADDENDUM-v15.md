# G5-1 v15 sample-count interpretation addendum

This note is controlling for any abbreviated statement of v15 sample intent.
...
V15 voluntarily preserves the deliberately stricter v1-lineage design:
...
preserves v15 as `PREMEASUREMENT_REVISE` without row reduction. A narrower
