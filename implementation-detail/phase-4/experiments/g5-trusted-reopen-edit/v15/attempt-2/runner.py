...
SCREEN_RESULT = REPO / f"target/phase4-g5-trusted-reopen-edit-{DATE}-v15-screen-attempt-2"
GATE_RESULT = REPO / f"target/phase4-g5-trusted-reopen-edit-{DATE}-v15-attempt-2"
WRAPPER_CALIBRATION_ROOT = (
    REPO / f"target/phase4-g5-trusted-reopen-edit-wrapper-calibration-{DATE}-v15-attempt-2"
)
