# G5-1 v11 sample-count interpretation addendum

This note is controlling for any abbreviated statement of v11 sample intent.
...
V11 voluntarily preserves the deliberately stricter v1-lineage design:
...
preserves v11 as `PREMEASUREMENT_REVISE` without row reduction. A narrower
