...
- Copy the frozen G4 v42 candidate executable exclusively into each result root,
...
200 arm observations total. If that complete schedule misses 120 seconds, v4
