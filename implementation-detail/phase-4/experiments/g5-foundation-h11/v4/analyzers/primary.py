...
V1 = HERE.parents[2] / "v1/analyzers/primary.py"
V2 = HERE.parents[2] / "v2/analyzers/primary.py"
...
def main(raw_path, expected_path, output_path):
    ...
    v1 = load("h11_v1_primary_for_v4", V1)
    v2 = load("h11_v2_primary_for_v4", V2)
    ...
    result["schema"] = "phase4-g5-h11-primary-analysis-v4"
