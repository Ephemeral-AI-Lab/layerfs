...
V016_EXTENDED_WATCHDOGS = {
    "v016-mixed-exhaustive-100mb-5000-k100-v1": 300,
    "v016-mixed-exhaustive-500mb-30000-k100-v1": 600,
    "v016-workspace-four-100mb-5000-k100-v1": 300,
}
# The special-case allowance: the long-history and load-bearing families need
# room for a full K100 schedule, its independent copy and its cleanup. The
# declared 15-second target stays reported separately as a target, never as a
# silent reduction of the workload.
V016_REGULAR_DEADLINE_SECONDS = 90


def v016_watchdog_seconds(selection):
    """The declared complete-command deadline of one v0.1.6 case, or None."""
    if selection.get("family") not in ("mixed_load_bearing", "multi_workspace_development",
                                       "branch_development"):
        return None
