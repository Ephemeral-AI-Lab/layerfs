...
6. PHASE_4A_DECISION_RECORD.md;
7. PHASE_4B_APPEND_ONLY_SPEC.md;
8. PHASE_4B_ACCEPTANCE_LEDGER.md;
9. PHASE_4B_BENCHMARK_REPORT.jsonl;
10. phase4-append-only-first-impl-finding.md;
11. PHASE_2_OPT2_SPEC.md and PHASE_2_HANDOFF.md;
...
4. Reconcile any missing final proxy facts into
   phase4-append-only-first-impl-finding.md. Label them exploratory,
   non-promotion evidence.
5. Add a short status notice near the top of PHASE_4B_APPEND_ONLY_SPEC.md and
   PHASE_4B_ACCEPTANCE_LEDGER.md stating that the candidate is rejected and
   superseded for active implementation by
   PHASE_4_ROLLING_BACK_TO_PREVIOUS_OPTIMIZATION_SPEC.md. Preserve all original
   requirements and evidence below the notice.
6. Create PHASE_4_ROLLBACK_DELETION_RECORD.md. Record starting HEAD, deleted
...
Complete PHASE_4_ROLLBACK_DELETION_RECORD.md with:
