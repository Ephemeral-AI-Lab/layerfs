...
| 8 | `stages-3-4-verification.md:67` vs `:110-113` | one clause says the E1 decision "is open", §4 records the written waiver | reconciled in §8 of that file by this round; the frozen §1/§2 text stays untouched. **Verified and closed 2026-09-17**: the clause stands in §2.1 as frozen text and §8.1 supersedes it, stating that the decision was answered on 2026-09-17 and that the row's status is unchanged — the campaign is `NOT_RUN`, only the reason moved from "waiting on a decision" to "waived in writing". §8.7 additionally flips the read-amplification row |
| 9 | `stages-3-4-closeout-report.md` (this batch's tracker) | the audit's findings were not carried in the report | recorded in the new §5 of that file by this round. **Verified and closed 2026-09-17**: §5 carries the nine numbered defects, §5.2 the per-item status, and §5.3 the three comparison axes; §2.1 is additionally corrected for the count, the missing F3 row and F10's status (C12), and §6 of the same file answers E1/E2/E3 |
