...
Evidence: `docs/roadmap/0.1/0.1.7/evidence/stage-6-history-209-ingest-20260920T232000Z/` — raw stdout per row, both saved Stores with sha256, and the source retained as `measure_ingest.rs.txt`.
