...
A B B A cancels a linear drift over the window: the treatment effect is
...
STEPS = [("a", ()), ("b", ("--env", "LAYERFS_STORAGE_POLICY_REASSERT=0")),
         ("b", ("--env", "LAYERFS_STORAGE_POLICY_REASSERT=0")), ("a", ())]
