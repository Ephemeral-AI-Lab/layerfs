#!/usr/bin/env python3
"""Collect one declared #190 diagnostic, never retry or overwrite a sample."""
import argparse
import contextlib
import fcntl
import hashlib
...
def main():
    ...
    with contextlib.ExitStack() as stack:
        ...
        document = {"schema": "h190-diagnostic-v1", "arm": args.arm,
                    ...
                    "pre_observation": before, "quiet_status": "no named competitors and >=70% CPU idle; desktop activity remains"}
