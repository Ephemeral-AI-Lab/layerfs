...
Status: **Shipped** in `fff509f3d` (the per-site instrument), `35aaf6f0b` (the treatment) and the analyses `9736ce633`, `703d612e2`, on top of L70. Reports: [round 12](../../0.1.7/evidence/issue219-ns19m-readsites-20260921T082557Z/), [round 13](../../0.1.7/evidence/issue219-ns19n-absence-20260921T082217Z/) — see the directory named `issue219-ns19n-absence-20260921T083217Z` — with pre-registrations beside each.
