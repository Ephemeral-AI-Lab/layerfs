...
- Commit: `ba64ed9`
- Date: 2026-08-10
- Status: retracted; independent audit found unresolved P0 correctness,
  boundedness, quota, migration, driver, expiry, and fault-injection blockers
...
- Known deviations: this artifact does not prove the current schema-v3 staging
  state machine and must not be used as release or milestone evidence
