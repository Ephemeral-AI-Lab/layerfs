...
- the refreshed SQLite Store misses the 600 MB primary footprint goal at
  661,913,600 median bytes; alternative storage architectures in issue #18
  are far-future, unscheduled exploration, not a promised optimization;
- the refreshed metadata-cardinality verifier is an explicitly tolerated 61.407-second
