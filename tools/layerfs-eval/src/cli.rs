pub(crate) fn run() {
    ...
    let result = match arguments.as_slice() {
        ...
        {
            crate::stage1_materialize::parity_row(
        ...
        {
            crate::stage1_materialize::attribution_block(
                std::path::Path::new(store),
                std::path::Path::new(source),
                size_mib,
                arm,
        ...
        {
            crate::stage1_materialize::trusted_block(
                std::path::Path::new(store),
                std::path::Path::new(source),
                size_mib,
                std::path::Path::new(work),
        ...
        {
            crate::stage1_materialize::hash(std::path::Path::new(path))
        }
        [stage1, materialize, prepare]
            if stage1 == "stage1" && materialize == "materialize" && prepare == "prepare" =>
        {
            crate::stage1_materialize::prepare()
        }
        ...
        {
            crate::stage1_materialize::manifest(
                role,
                commit,
        ...
        {
            crate::stage1_materialize::parity_readiness(
        ...
        {
            crate::stage1_materialize::parity_run(
                std::path::Path::new(historical),
                std::path::Path::new(instrumented),
                std::path::Path::new(store),
                std::path::Path::new(source),
        ...
        {
            crate::stage1_materialize::attribution_run(
        ...
        {
            crate::stage1_materialize::trusted_run(
                std::path::Path::new(fixture),
        ...
        {
            crate::stage1_materialize::acceptance_run(
                std::path::Path::new(control),
