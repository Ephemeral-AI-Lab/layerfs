...
- Controlling specification:
  `PHASE_4_ROLLING_BACK_TO_PREVIOUS_OPTIMIZATION_SPEC.md`
...
3. Reconcile the latest proxy campaign into
   `phase4-append-only-first-impl-finding.md` as non-promotion evidence if the
   result is not already recorded.
4. Label `PHASE_4B_APPEND_ONLY_SPEC.md` and
   `PHASE_4B_ACCEPTANCE_LEDGER.md` as superseded/rejected for active work while
