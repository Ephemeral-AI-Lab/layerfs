...
volume="layerfs_stage2_final014_fault_store"
evidence="$(cd "$(dirname "$0")/.." && pwd)/forced-death"
names=(
  layerfs-stage2-final014-fault-pre
  layerfs-stage2-final014-fault-pre-reopen
  layerfs-stage2-final014-fault-post
  layerfs-stage2-final014-fault-post-reopen
)
