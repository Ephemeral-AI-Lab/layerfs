...
volume="layerfs_stage2_final013_splice_store"
evidence="$(cd "$(dirname "$0")" && pwd)"
names=(
  layerfs-stage2-final013-splice-baseline
  layerfs-stage2-final013-splice-control
  layerfs-stage2-final013-splice-remount
)
