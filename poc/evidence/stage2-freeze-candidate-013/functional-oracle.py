...
def await_next_cpu_period():
    ...
    while cpu_stat()["nr_periods"] == period:
        ...
        # Stay within 100 us of the observed 100 ms CFS boundary so the
        # checkpoint receives the full one-CPU quota the comment below claims.
        time.sleep(0.0001)
...
def main():
    ...
    receipt = {
        "schema": "layerfs-stage2-functional-oracle-v4",
