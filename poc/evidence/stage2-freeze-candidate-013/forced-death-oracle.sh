...
volume="layerfs_stage2_final013_fault_store"
evidence="$(cd "$(dirname "$0")" && pwd)"
names=(
  layerfs-stage2-final013-fault-pre
  layerfs-stage2-final013-fault-pre-reopen
  layerfs-stage2-final013-fault-post
  layerfs-stage2-final013-fault-post-reopen
)
