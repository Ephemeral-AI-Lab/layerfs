...
volume="layerfs_stage2_final012_fault_store"
evidence="$(cd "$(dirname "$0")" && pwd)"
names=(
  layerfs-stage2-final012-fault-pre
  layerfs-stage2-final012-fault-pre-reopen
  layerfs-stage2-final012-fault-post
  layerfs-stage2-final012-fault-post-reopen
)
