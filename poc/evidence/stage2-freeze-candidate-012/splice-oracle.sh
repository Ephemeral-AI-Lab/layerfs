...
volume="layerfs_stage2_final012_splice_store"
evidence="$(cd "$(dirname "$0")" && pwd)"
names=(
  layerfs-stage2-final012-splice-baseline
  layerfs-stage2-final012-splice-control
  layerfs-stage2-final012-splice-remount
)
