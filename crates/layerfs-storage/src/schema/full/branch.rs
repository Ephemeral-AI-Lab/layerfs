//! Full accepted Branch, merge-delta, and ordered-transition DDL.
    ...
    (
        ...
        "CREATE TABLE layerfs_branches (
            ...
            FOREIGN KEY(immediate_parent_branch_id, fork_operation_version_id)
                ...
                DEFERRABLE INITIALLY DEFERRED,
            FOREIGN KEY(fork_root_id) REFERENCES layerfs_objects(object_id)
                DEFERRABLE INITIALLY DEFERRED,
    ...
    (
        ...
        "CREATE TABLE layerfs_branch_deltas (
            ...
            FOREIGN KEY(base_root_id) REFERENCES layerfs_objects(object_id)
                DEFERRABLE INITIALLY DEFERRED,
            FOREIGN KEY(source_root_id) REFERENCES layerfs_objects(object_id)
                DEFERRABLE INITIALLY DEFERRED,
            FOREIGN KEY(destination_root_id) REFERENCES layerfs_objects(object_id)
                DEFERRABLE INITIALLY DEFERRED,
