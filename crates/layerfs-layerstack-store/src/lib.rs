...
pub use objects::{
    ...
    reconcile_candidate_with, BuildCounters, BuiltRoot, CandidateCleanup, CandidateReconciliation,
    CanonicalObject, CoreReader, DeferredObjectStore, ObjectBuffer, ObjectSource,
    SpillableObjectSet, OBJECT_PAGE_BYTES, OBJECT_PAGE_COUNT,
};
pub use records::{
...
pub use telemetry::{
    ...
    note_workspace_commit_sort, note_workspace_commit_tracking, note_workspace_commit_tree_visits,
    note_workspace_create_snapshot, note_workspace_fingerprint_memory,
