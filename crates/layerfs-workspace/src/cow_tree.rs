...
pub(crate) struct Node {
    ...
    /// Authenticated count in base_root; never derived from materialized paths.
    pub(crate) base_ref_count: u64,
...
impl Workspace {
    ...
    pub(crate) fn from_snapshot(
        ...
        let root = Node {
            ...
            base_ref_count: resolved.record.namespace_ref_count,
    ...
    fn materialize_record(
        ...
        let node = self.allocate(Node {
            ...
            base_ref_count: record.namespace_ref_count,
