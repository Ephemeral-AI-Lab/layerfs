...
try:
    ...
    for arm,enabled in [('control','0'),('cached','1')]:
        start(arm)
        ...
        run(arm+'-run',['docker','exec','-e','LAYERFS_EXPERIMENT_METADATA_CACHE='+enabled,active,'fs-benchmark-pro','workspace-run','/data/sample','/unused-input','tiny-bulk-create-10','1','verify','diagnostic-host-fuse'])
