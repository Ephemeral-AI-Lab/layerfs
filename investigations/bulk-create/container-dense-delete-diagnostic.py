...
try:
    ...
    for kind in ['delete']:
      for treatment,batch in [('control','0'),('survivors','1')]:
        arm=kind+'-'+treatment
        ...
        run(arm+'-run',['docker','exec','-e','LAYERFS_EXPERIMENT_DENSE_DELETE='+batch,active,'fs-benchmark-pro','workspace-run','/data/sample','/unused-input','tiny-bulk-'+kind+'-10','1','verify','diagnostic-host-fuse'])
