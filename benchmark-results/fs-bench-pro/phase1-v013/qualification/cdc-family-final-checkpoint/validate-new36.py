"""Exactly36 new e24 CDC fast verdicts; all prior qualified results excluded."""
...
assert len(rows)==36 and len({x['environment_identity'] for x in rows})==1
