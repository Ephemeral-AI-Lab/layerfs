...
assessment=r.read(OUT/'suppression-resource-assessment.json');issues=assessment['issues'];violations=assessment['violations'];resources=assessment
assert issues==[] and violations==['worker exceeded frozen case deadline']
assert x['supervisor_failure']=='product-time-budget' and x['timeout'] is True
