...
const CREATE_STATEMENTS = [
  ...
  `CREATE TABLE efs_gc_runs (id TEXT PRIMARY KEY, state INTEGER NOT NULL, high_water INTEGER NOT NULL, root_generation INTEGER NOT NULL, cursor_kind INTEGER NOT NULL, cursor_value BLOB, created_at_ms INTEGER NOT NULL) WITHOUT ROWID`,
  `CREATE TABLE efs_gc_marks (run_id TEXT NOT NULL REFERENCES efs_gc_runs(id) ON DELETE CASCADE, kind INTEGER NOT NULL, hash BLOB NOT NULL, PRIMARY KEY(run_id,kind,hash)) WITHOUT ROWID`,
