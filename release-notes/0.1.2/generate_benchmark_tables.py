...
def render(families, source, environment):
    lines = ["# LayerFS 0.1.2 SDK-only edit candidate evidence", "",
             ...
             "", "Candidate medians satisfy the frozen 10/10/20 ms edit/Commit/combined ceilings, size parity, matched-operation parity, no-amplification, memory, correctness, cleanup, and custody gates. Baseline latency is diagnostic; baseline correctness and resources remain binding.",
