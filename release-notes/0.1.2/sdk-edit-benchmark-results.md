# LayerFS 0.1.2 detailed SDK edit benchmark results

> **Status:** Release-note presentation of the sealed issue #20 results. The original measurements and classifications are unchanged; see [benchmark overview](benchmark-results.md) for the later release-source fix and supporting-family refresh.
...
Raw bundles, source identities, and SHA-256 manifests are pinned in [inputs.json](../../benchmark-results/fs-bench-pro/sdk-edit-terminal/final-3337728e/inputs.json). Full machine-readable statistics and original findings are in [classification.json](../../benchmark-results/fs-bench-pro/sdk-edit-terminal/final-3337728e/classification.json).

Performance collection finished for all three families before verification. One baseline 10 MiB zero-extension verifier returned InvalidRequest; its container exited 0 without OOM. The failed attempt is retained, six missing proofs passed on retry, and the original 58-proof prefix and all performance bytes were preserved. At original issue #20 closure, the cause of that isolated control error was unproven. It was subsequently reproduced as a daemon close/remount race and fixed before release; see the [release overview](benchmark-results.md).

## edit_length_preserving

Performance rows: 120; final classification: pass.

[Raw performance](../../benchmark-results/fs-bench-pro/edit-length-preserving/terminal-3337728e/performance/raw.jsonl) · [Verification subproofs](../../benchmark-results/fs-bench-pro/edit-length-preserving/terminal-3337728e/verification/subproofs.jsonl) · [Manifest](../../benchmark-results/fs-bench-pro/edit-length-preserving/terminal-3337728e/evidence.sha256)
...
[Raw performance](../../benchmark-results/fs-bench-pro/edit-length-changing/terminal-3337728e/performance/raw.jsonl) · [Verification subproofs](../../benchmark-results/fs-bench-pro/edit-length-changing/terminal-3337728e/verification/subproofs.jsonl) · [Manifest](../../benchmark-results/fs-bench-pro/edit-length-changing/terminal-3337728e/evidence.sha256)
...
[Raw performance](../../benchmark-results/fs-bench-pro/edit-canonical-chunk-count/terminal-3337728e/performance/raw.jsonl) · [Verification subproofs](../../benchmark-results/fs-bench-pro/edit-canonical-chunk-count/terminal-3337728e/verification/subproofs.jsonl) · [Manifest](../../benchmark-results/fs-bench-pro/edit-canonical-chunk-count/terminal-3337728e/evidence.sha256)
