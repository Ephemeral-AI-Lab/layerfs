...
Historical reproduction command, once per case with a **new** output path.
Run it from the issue #237 source commit `a5b0a7326`; `main` now has the
SDK-only Init runner and a different benchmark contract:
