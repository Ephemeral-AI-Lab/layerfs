...
image = 'sha256:4aaefea1c88db91c8f7537d70248346ed0159e90362fcd1b76712f6a0c80b346'
assert subprocess.check_output(['docker', 'image', 'inspect', image, '--format', '{{.Id}}'], text=True).strip() == image
run = secrets.randbits(128) or 1
output = Path(tempfile.mkdtemp(prefix='sdk-route-accept-poll-', dir=repo/'core/target/sdk-proof/evidence'))
