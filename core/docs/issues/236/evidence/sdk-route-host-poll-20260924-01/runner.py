...
assert source_commit == '436a93ae6ec8b678dc6c6d2c38a2e830f1ea55ab'
...
output = Path(tempfile.mkdtemp(prefix='sdk-route-host-poll-', dir=repo/'core/target/sdk-proof/evidence'))
