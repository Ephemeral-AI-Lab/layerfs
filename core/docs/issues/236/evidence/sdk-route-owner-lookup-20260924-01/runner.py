...
assert source_commit == 'e448f534a1aecd79d2bcc0cd72305a6104d994dc'
...
output = Path(tempfile.mkdtemp(prefix='sdk-route-owner-lookup-', dir=repo/'core/target/sdk-proof/evidence'))
