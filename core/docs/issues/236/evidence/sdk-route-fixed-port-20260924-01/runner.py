...
assert source_commit == '00e7374ff1e6d86d176aab90379bf040a3cf036f'
...
output = Path(tempfile.mkdtemp(prefix='sdk-route-fixed-port-', dir=repo/'core/target/sdk-proof/evidence'))
