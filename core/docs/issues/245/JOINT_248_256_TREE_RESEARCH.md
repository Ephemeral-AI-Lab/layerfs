...
| file_tree/mod.rs | <100 | Thin length-indexed tree surface. |
| file_tree/format.rs | 180–280 | PieceRecord/ChildRef codec and checks. |
| file_tree/splice.rs | 450–650 | Level-aware path copy and balancing. |
| file_tree/cursor.rs | 370–520 | Byte-position traversal. |
| key_tree/mod.rs | <100 | Thin key-indexed tree surface. |
| key_tree/format.rs | 150–260 | Cell/fence codec and checks. |
| key_tree/update.rs | 350–520 | Find, insert and split. |
| key_tree/delete.rs | 200–350 | Delete and sibling rebalance. |
| key_tree/cursor.rs | 150–240 | Ordered key traversal. |
| key_tree/build.rs | 180–330 | Multilevel ordered builder. |
